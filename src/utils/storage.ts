...
export const saveDataAsyncStorage = async (key: string, value: string): Promise<void> => {
  try {
...
export const saveDataSecureStorage = async (key: string, value: string): Promise<void> => {
  try {
...
export const saveEncryptedDataAsyncStorage = async (key: string, value: string): Promise<void> => {
...
export const getDataEncryptedAsyncStorage = async (key: string): Promise<any> => {
  const secureStoreIsAvailable = await isAvailableAsync();
  if (secureStoreIsAvailable) {
...
export const removeEncryptedDataAsyncStorage = async (key: string): Promise<void> => {
  const secureStoreIsAvailable = await isAvailableAsync();
  if (secureStoreIsAvailable) {
    try {
     await deleteItemAsync(key);
